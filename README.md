...
# noixDoG BETA 1.0 Official Development Repo


This is in BETA. No gurantee any pulls will actually work as of today, 2/20/18. Use at your own risk. 

noixDoG is an inexpensive and decentralized ledger to be used by businesses for tracking share ownership in an automated fashion. Shares can be transferred and held just like other cryptocurrency units, such as peercoins or bitcoins.
...
Each business using noixDoG will have their own blockchain that is independent of all others. Blockchains can be secured cheaply and easily using noixDoG's proof-of-stake, once the initial (issuer-controlled) quantity of shares have been generated using proof-of-work.
